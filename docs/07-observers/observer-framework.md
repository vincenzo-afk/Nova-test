...
| Mouse         | `mouse_activity`: activity/idle signal; current position only through an on-demand authorized read                                 | Continuous movement trail, click history, button state, and continuous position capture                           | `mouse.md`         |
