# Home / Dashboard — Screen Spec

## Purpose

At-a-glance summary of pending approvals, recent autonomous actions, and suggested next steps, so the user never has to open Chat just to check status.
