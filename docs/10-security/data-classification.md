...
nothing here overrides that. Classification here governs *other*
...
| **Observed content (raw)** | Clipboard content, keystroke/mouse content, screen content | Never captured at all (keyboard/mouse) or gated by observation permission level (clipboard); never in diagnostic logs regardless | `docs/07-observers/clipboard.md`, `keyboard.md`, `mouse.md`; exclusions in `docs/13-devops/logging.md` |
