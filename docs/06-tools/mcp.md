...
URIs retained, before a listing mutates the cache. Non-string or otherwise
malformed server IDs and resource metadata fail closed before cache access or
mutation; misses never trigger resource discovery, refresh, reads, URI
