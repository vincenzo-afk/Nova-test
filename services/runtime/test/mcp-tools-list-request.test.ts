...
import { McpToolsListRequestBuilder } from "../src/mcp-tools-list-request.js";

describe("McpToolsListRequestBuilder", () => {
  it("builds a fixed tools/list request without optional parameters", () => {
    const builder = new McpToolsListRequestBuilder();
